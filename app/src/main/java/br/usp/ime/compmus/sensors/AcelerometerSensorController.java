...
public class AcelerometerSensorController implements SensorController{

	private float originalMaxRange = (float) 9.81;
	private float originalMinRange = 0;
	private float maxRange = (float) 9.81;
	private float minRange = 0;
	private int eventValueSelected = 0;
	private int sensorType = Sensor.TYPE_ACCELEROMETER;
	
	public AcelerometerSensorController(int event){
